...
AI_SYSTEM = (
    ...
    "Foydalanuvchi bergan matndan (PDF dan olingan) dars mazmunini ajratib, "
    "QAT'IY faqat JSON ko'rinishida qaytar. Hech qanday izoh, markdown belgisi yoki ortiqcha matn YO'Q. "
    "uz maydonlari — o'zbekcha tarjima. Agar biror bo'lim matnda bo'lmasa, bo'sh ro'yxat [] yoki bo'sh satr qoldir. "
    "Hech narsa o'zingdan to'qima — faqat berilgan matndagi ma'lumotni ishlat. JSON sxemasi:\n"
    '{"title":"dars nomi","shadowing_ru":"","shadowing_uz":"","razgovor_start":"",'
    '"vocab":[{"ru":"","uz":"","ex":""}],'
    '"formulas":[{"ru":"","uz":""}],'
    '"reading_texts":[{"label":"","ru":"","uz":""}],'
...
.lrow{display:flex;gap:6px;margin-bottom:6px;align-items:flex-start;}
.lrow .lfield{flex:1;}
...
var SCHEMA={
  vocab:[{k:'ru',l:'Ruscha'},{k:'uz',l:"O'zbekcha"},{k:'ex',l:'Misol'}],
  formulas:[{k:'ru',l:'Ruscha'},{k:'uz',l:"O'zbekcha"}],
  reading_texts:[{k:'label',l:'Sarlavha (A1 daraja)'},{k:'ru',l:'Ruscha matn',a:1},{k:'uz',l:"O'zbekcha tarjima",a:1}],
