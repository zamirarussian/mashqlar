...
def save_content_full(level, day, d):
    ...
    cur.execute("""
        INSERT INTO content (level, day, title, shadowing_ru, shadowing_uz, razgovor_start,
            ...
            grammar_video, writing_task, writing_sample, taqlid_video, taqlid_type)
        VALUES (%s,%s,%s,%s,%s,%s,%s::jsonb,%s::jsonb,%s::jsonb,%s::jsonb,%s::jsonb,%s::jsonb,%s::jsonb,%s,%s,%s,%s,%s)
...
<div class="main">
  ...
  <div class="panel" id="p-ui">
    ...
    <div class="section">
      ...
      <div class="hint" style="margin-bottom:10px;">Foydalanuvchi botni ochganda yuboriladigan xabar. <b>{ism}</b> — foydalanuvchi ismi, <b>{id}</b> — ID raqami. Markdown ishlaydi: *qalin*, `kod`. Bo'sh qoldirsangiz standart matn ishlaydi; «Darsni boshlash» tugmasi doim qoladi.</div>
...
<div class="screen" id="sc-audio">
  ...
  <div class="fixed">
    <div class="subt">TAQLID MASHQI — turi</div>
    <label class="flbl">Bu kun taqlid turi</label>
    <select id="f_taqlid_type" style="width:100%;padding:11px;border-radius:9px;border:1px solid #ccc;font-family:inherit;font-size:14px;">
      <option value="audio">🎧 Audio (pastdagi «Taqlid» audiosidan)</option>
      <option value="video">🎬 Video (YouTube)</option>
    </select>
    <label class="flbl">Taqlid video (YouTube URL) — «Video» tanlansa</label>
