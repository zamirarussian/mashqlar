...
<div class="main">
  ...
  <div class="panel" id="p-ui">
    ...
    <div class="section">
      ...
      <div class="hint">Foydalanuvchi botni ochganda yuboriladigan xabar. <b>{ism}</b> — foydalanuvchi ismi, <b>{id}</b> — ID raqami. Markdown ishlaydi: *qalin*, `kod`. Bo'sh qoldirsangiz standart matn ishlaydi; «Darsni boshlash» tugmasi doim qoladi.</div>
