...
def save_content_full(level, day, d):
    ...
    cur.execute("""
        INSERT INTO content (level, day, title, shadowing_ru, shadowing_uz, razgovor_start,
            ...
            grammar_video, writing_task, writing_sample, taqlid_video, taqlid_type, writing_tasks)
        VALUES (%s,%s,%s,%s,%s,%s,%s::jsonb,%s::jsonb,%s::jsonb,%s::jsonb,%s::jsonb,%s::jsonb,%s::jsonb,%s,%s,%s,%s,%s,%s::jsonb)
...
var LISTS=['vocab','formulas','reading_texts','grammar','speaking_questions','audio_questions','writing_tasks'];
